  ...
  return (
    <div className="max-w-6xl mx-auto px-6 pt-8 pb-2">
      <div className="flex items-center gap-3">
        <Image src="/logo-productivilab.png" alt="ProductiviLab" width={960} height={480} className="h-8 w-auto md:h-12 lg:h-14" priority />
      </div>
    </div>
  );
}
...
export default function Page() {
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-8">
      ...
      {/* 🔽 Añade aquí el bloque del nuevo producto */}
